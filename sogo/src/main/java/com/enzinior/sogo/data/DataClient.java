...
public interface DataClient {
	...
	Response findDefaultInfo(@RequestParam("MobileOS") String MobileOS, @RequestParam("MobileApp") String MobileApp,
	...
	// ResponseInfo findIntroInfo(@RequestParam("MobileOS") String MobileOS, @RequestParam("MobileApp") String MobileApp,
	...
	// ResponseWith findWithInfo(@RequestParam("MobileOS") String MobileOS, @RequestParam("MobileApp") String MobileApp,
