...
public class SummaryService {
	...
	public String generateSummary(String inputText) {
		String prompt = "너는 이제부터 여행 사이트를 운영하는 운영자야.\n"
			...
			+ "\n"
			+ "한줄 요약에는 어떤 장소인지에 대한 설명이 다 들어가 있어야 해. 길이는 길지 않게 20자 내로 작성해줘. 장소의 종류에 대한 설명과 특별한 부분이 있다면 그런 내용이 보여질 수 있도록 작성해줘. 한줄 요약이라는 말은 굳이 앞에 붙일 필요 없이 내용만 줘\n"
			+ "\n"
